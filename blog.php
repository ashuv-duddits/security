...
//создаем массив пользователей, в котром ключ - идентификатор пользователя
...
<? foreach ($posts as $post) : ?>
    <div class="post">
        <span class="user">Сообщение от <b><?=$userById[$post['user_id']]['name'];?></b> отправлено <?=$post['datetime'];?></span>
